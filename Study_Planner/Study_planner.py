...
def get_subject() : # 공부 종목과 각각의 공부 시간 데이터
    ...
    return subject_entries_value, time_entries_value

def get_time_data() : # 일당/주당 공부 가능 시간 데이터
    window = tk.Tk()

    day = ['월요일', '화요일', '수요일', '목요일', '금요일', '토요일', '일요일']
    # time = ['4시', '5시', '6시', '7시', '8시', '9시', '10시', '11시']
    time = ['11:30~12:20','13:20~14:10','14:20~15:10','15:20~16:10','16:20~17:10','17:20~18:10','19:10~20:00','20:10~21:00','21:10~22:00']
    ...
    getted_checkbox_vars = []
    for i in range(len(checkbox_vars)) : 
        for j in range(len(checkbox_vars[i])) : 
            getted_checkbox_vars.append(checkbox_vars[i][j].get())

    return getted_checkbox_vars
...
subject_entries_value, time_entries_value = get_subject()
checkbox_vars = get_time_data()

print(subject_entries_value)
print(time_entries_value)
print(checkbox_vars)